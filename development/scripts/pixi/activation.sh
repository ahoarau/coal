...
export COAL_BUILD_WITH_LOGGING=${COAL_BUILD_WITH_LOGGING:=OFF}
export COAL_BUILD_WITH_QHULL=${COAL_BUILD_WITH_QHULL:=OFF}
export COAL_BUILD_WITH_ASSIMP=${COAL_BUILD_WITH_ASSIMP:=OFF}
