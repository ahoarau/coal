...
if not defined COAL_BUILD_WITH_LOGGING (set COAL_BUILD_WITH_LOGGING=OFF)
if not defined COAL_BUILD_WITH_QHULL (set COAL_BUILD_WITH_QHULL=OFF)
if not defined COAL_BUILD_WITH_ASSIMP (set COAL_BUILD_WITH_ASSIMP=OFF)
